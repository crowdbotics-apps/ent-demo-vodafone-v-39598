  ...
  return <View style={styles.container}>
      ...
      <View>
        <View style={styles.emailContainer}>
          ...
          <View>
      <TextInput style={textStyles.input} placeholder="Email" placeholderTextColor="#ddd" />
    </View>
        </View>
        <View style={styles.mb20}>
          <Text style={styles.mr10}>Password</Text>
          <View>
      <TextInput style={textStyles.input} placeholder="Password" placeholderTextColor="#ddd" />
    </View>
        </View>
